...
- [x] **Workout Planner (iOS)**: Build an interface to create a `PlannedWorkout` consisting of multiple `PlannedExercise` items (target sets, reps, weight, and rest durations).
